    ...
    <div className="container mx-auto p-4 md:p-8 space-y-8">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Welcome back! Here's a summary of your help desk.</p>
        </div>
        <ClientOnly>
          <Button asChild>
            <Link href="/create">
            ...
            <Card className="lg:col-span-2">
                ...
                {loading ? (
                    ...
                    {recentTickets.map((ticket: Ticket) => (
                        <li key={ticket.id} className="flex items-center justify-between p-3 bg-secondary rounded-lg">
                        <div>
